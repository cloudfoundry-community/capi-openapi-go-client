...
type PlanSchemasServiceInstance struct {
	...
	Update *PlanSchemasServiceBindingCreate `json:"update,omitempty"`
}
...
// SetUpdate gets a reference to the given PlanSchemasServiceBindingCreate and assigns it to the Update field.
