...
type ServiceCredentialBindingLinks struct {
	...
	Details *V3IsolationSegmentsGuidRelationshipsOrganizationsGet200ResponseLinksRelated `json:"details,omitempty"`
	Parameters *V3IsolationSegmentsGuidRelationshipsOrganizationsGet200ResponseLinksRelated `json:"parameters,omitempty"`
	Self *V3IsolationSegmentsGuidRelationshipsOrganizationsGet200ResponseLinksRelated `json:"self,omitempty"`
	ServiceInstance *V3IsolationSegmentsGuidRelationshipsOrganizationsGet200ResponseLinksRelated `json:"service_instance,omitempty"`
}
...
// SetDetails gets a reference to the given V3IsolationSegmentsGuidRelationshipsOrganizationsGet200ResponseLinksRelated and assigns it to the Details field.
...
// SetParameters gets a reference to the given V3IsolationSegmentsGuidRelationshipsOrganizationsGet200ResponseLinksRelated and assigns it to the Parameters field.
...
// SetServiceInstance gets a reference to the given V3IsolationSegmentsGuidRelationshipsOrganizationsGet200ResponseLinksRelated and assigns it to the ServiceInstance field.
