...
// SetDestinations gets a reference to the given Link and assigns it to the Destinations field.
...
// SetDomain gets a reference to the given Link and assigns it to the Domain field.
