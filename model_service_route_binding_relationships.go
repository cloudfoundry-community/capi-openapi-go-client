...
type ServiceRouteBindingRelationships struct {
	Route *V3AppsPostRequestRelationshipsSpace `json:"route,omitempty"`
...
// SetRoute gets a reference to the given V3AppsPostRequestRelationshipsSpace and assigns it to the Route field.
