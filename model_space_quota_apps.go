...
// checks if the SpaceQuotaApps type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SpaceQuotaApps{}

// SpaceQuotaApps Application resource limits
...
type _SpaceQuotaApps SpaceQuotaApps
...
func (o SpaceQuotaApps) MarshalJSON() ([]byte, error) {
...
func (o SpaceQuotaApps) ToMap() (map[string]interface{}, error) {
...
func (o *SpaceQuotaApps) UnmarshalJSON(data []byte) (err error) {
	...
	varSpaceQuotaApps := _SpaceQuotaApps{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSpaceQuotaApps)

	if err != nil {
		return err
	}

	*o = SpaceQuotaApps(varSpaceQuotaApps)

	return err
}

type NullableSpaceQuotaApps struct {
	value *SpaceQuotaApps
	isSet bool
}

func (v NullableSpaceQuotaApps) Get() *SpaceQuotaApps {
	return v.value
}

func (v *NullableSpaceQuotaApps) Set(val *SpaceQuotaApps) {
	v.value = val
	v.isSet = true
}

func (v NullableSpaceQuotaApps) IsSet() bool {
	return v.isSet
}

func (v *NullableSpaceQuotaApps) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSpaceQuotaApps(val *SpaceQuotaApps) *NullableSpaceQuotaApps {
	return &NullableSpaceQuotaApps{value: val, isSet: true}
}

func (v NullableSpaceQuotaApps) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSpaceQuotaApps) UnmarshalJSON(src []byte) error {
	v.isSet = true
