...
type ResourceMatchObject struct {
	Checksum *ResourceMatchObjectChecksum `json:"checksum,omitempty"`
...
func (o *ResourceMatchObject) GetChecksum() ResourceMatchObjectChecksum {
	if o == nil || IsNil(o.Checksum) {
		var ret ResourceMatchObjectChecksum
		return ret
	}
	return *o.Checksum
}
...
// SetChecksum gets a reference to the given ResourceMatchObjectChecksum and assigns it to the Checksum field.
