...
Compare provided manifest with current app configuration. This is an experimental endpoint.
 ...
 @return ApiV3AppsGuidManifestDiffPostRequest
*/
func (a *ExperimentalAPIService) V3AppsGuidManifestDiffPost(ctx context.Context, guid string) ApiV3AppsGuidManifestDiffPostRequest {
	return ApiV3AppsGuidManifestDiffPostRequest{
		ApiService: a,
		ctx: ctx,
		guid: guid,
...
//  @return V3AppsGuidManifestDiffPost200Response
func (a *ExperimentalAPIService) V3AppsGuidManifestDiffPostExecute(r ApiV3AppsGuidManifestDiffPostRequest) (*V3AppsGuidManifestDiffPost200Response, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ExperimentalAPIService.V3AppsGuidManifestDiffPost")
	if err != nil {
...
List all spaces that a route is shared with. This is an experimental feature.
 ...
 @return ApiV3RoutesGuidRelationshipsSharedSpacesGetRequest
*/
func (a *ExperimentalAPIService) V3RoutesGuidRelationshipsSharedSpacesGet(ctx context.Context, guid string) ApiV3RoutesGuidRelationshipsSharedSpacesGetRequest {
	return ApiV3RoutesGuidRelationshipsSharedSpacesGetRequest{
		ApiService: a,
		ctx: ctx,
		guid: guid,
...
// Execute executes the request
//  @return V3RoutesGuidRelationshipsSharedSpacesGet200Response
func (a *ExperimentalAPIService) V3RoutesGuidRelationshipsSharedSpacesGetExecute(r ApiV3RoutesGuidRelationshipsSharedSpacesGetRequest) (*V3RoutesGuidRelationshipsSharedSpacesGet200Response, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ExperimentalAPIService.V3RoutesGuidRelationshipsSharedSpacesGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
Share a route with another space, allowing apps in that space to be mapped to the route. This is an experimental feature.
 ...
 @return ApiV3RoutesGuidRelationshipsSpacePatchRequest
*/
func (a *ExperimentalAPIService) V3RoutesGuidRelationshipsSpacePatch(ctx context.Context, guid string) ApiV3RoutesGuidRelationshipsSpacePatchRequest {
	return ApiV3RoutesGuidRelationshipsSpacePatchRequest{
		ApiService: a,
		ctx: ctx,
		guid: guid,
...
// Execute executes the request
//  @return V3RoutesGuidRelationshipsSpacePatch200Response
func (a *ExperimentalAPIService) V3RoutesGuidRelationshipsSpacePatchExecute(r ApiV3RoutesGuidRelationshipsSpacePatchRequest) (*V3RoutesGuidRelationshipsSpacePatch200Response, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ExperimentalAPIService.V3RoutesGuidRelationshipsSpacePatch")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
