...
type V3AppsPostRequest struct {
	...
	Relationships *V3AppsPostRequestRelationships `json:"relationships,omitempty"`
	// GUID of the space.
...
// SetRelationships gets a reference to the given V3AppsPostRequestRelationships and assigns it to the Relationships field.
