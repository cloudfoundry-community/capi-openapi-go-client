...
type IsolationSegmentLinks struct {
	Organizations *V3AppsGuidActionsApplyManifestPost202ResponseLinksJob `json:"organizations,omitempty"`
...
// SetOrganizations gets a reference to the given V3AppsGuidActionsApplyManifestPost202ResponseLinksJob and assigns it to the Organizations field.
