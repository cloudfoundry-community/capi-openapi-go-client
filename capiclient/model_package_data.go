...
// PackageData Package type specific data
type PackageData struct {
	Checksum *PackageDataChecksum `json:"checksum,omitempty"`
	// Error message if package processing failed
	Error NullableString `json:"error,omitempty"`
	// Image reference for docker/cnb packages
	Image *string `json:"image,omitempty"`
	// Registry password (write-only)
	Password *string `json:"password,omitempty"`
	// Registry username (write-only)
