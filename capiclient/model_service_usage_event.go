...
type ServiceUsageEvent struct {
	...
	Organization NullableServiceUsageEventOrganization `json:"organization,omitempty"`
...
func (o *ServiceUsageEvent) GetOrganization() ServiceUsageEventOrganization {
	if o == nil || IsNil(o.Organization.Get()) {
		var ret ServiceUsageEventOrganization
		return ret
	}
...
// SetOrganization gets a reference to the given NullableServiceUsageEventOrganization and assigns it to the Organization field.
