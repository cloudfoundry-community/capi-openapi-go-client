...
type PlatformInfoLinks struct {
	...
	Support *V3IsolationSegmentsGuidRelationshipsOrganizationsGet200ResponseLinksRelated `json:"support,omitempty"`
}
...
// SetSupport gets a reference to the given V3IsolationSegmentsGuidRelationshipsOrganizationsGet200ResponseLinksRelated and assigns it to the Support field.
