...
type ServiceOfferingRelationships struct {
	ServiceBroker *AssignDefaultIsolationSegmentRequest `json:"service_broker,omitempty"`
}
...
// SetServiceBroker gets a reference to the given AssignDefaultIsolationSegmentRequest and assigns it to the ServiceBroker field.
