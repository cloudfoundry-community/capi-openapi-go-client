...
// checks if the RateLimitExceededError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RateLimitExceededError{}

// RateLimitExceededError struct for RateLimitExceededError
...
type _RateLimitExceededError RateLimitExceededError
...
func (o RateLimitExceededError) MarshalJSON() ([]byte, error) {
...
func (o RateLimitExceededError) ToMap() (map[string]interface{}, error) {
...
func (o *RateLimitExceededError) UnmarshalJSON(data []byte) (err error) {
	...
	varRateLimitExceededError := _RateLimitExceededError{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRateLimitExceededError)

	if err != nil {
		return err
	}

	*o = RateLimitExceededError(varRateLimitExceededError)

	return err
}

type NullableRateLimitExceededError struct {
	value *RateLimitExceededError
	isSet bool
}

func (v NullableRateLimitExceededError) Get() *RateLimitExceededError {
	return v.value
}

func (v *NullableRateLimitExceededError) Set(val *RateLimitExceededError) {
	v.value = val
	v.isSet = true
}

func (v NullableRateLimitExceededError) IsSet() bool {
	return v.isSet
}

func (v *NullableRateLimitExceededError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRateLimitExceededError(val *RateLimitExceededError) *NullableRateLimitExceededError {
	return &NullableRateLimitExceededError{value: val, isSet: true}
}

func (v NullableRateLimitExceededError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRateLimitExceededError) UnmarshalJSON(src []byte) error {
	v.isSet = true
