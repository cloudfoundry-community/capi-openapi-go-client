...
// checks if the V3RoutesGet200ResponsePagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V3RoutesGet200ResponsePagination{}

// V3RoutesGet200ResponsePagination struct for V3RoutesGet200ResponsePagination
type V3RoutesGet200ResponsePagination struct {
...
func NewV3RoutesGet200ResponsePagination() *V3RoutesGet200ResponsePagination {
	this := V3RoutesGet200ResponsePagination{}
	return &this
}
...
func (o *V3RoutesGet200ResponsePagination) SetFirst(v Get200ResponseLinksLogCache) {
	o.First = &v
}
...
func (o *V3RoutesGet200ResponsePagination) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o V3RoutesGet200ResponsePagination) MarshalJSON() ([]byte, error) {
...
func (o V3RoutesGet200ResponsePagination) ToMap() (map[string]interface{}, error) {
...
type NullableV3RoutesGet200ResponsePagination struct {
	value *V3RoutesGet200ResponsePagination
	isSet bool
}

func (v NullableV3RoutesGet200ResponsePagination) Get() *V3RoutesGet200ResponsePagination {
	return v.value
}

func (v *NullableV3RoutesGet200ResponsePagination) Set(val *V3RoutesGet200ResponsePagination) {
	v.value = val
	v.isSet = true
}

func (v NullableV3RoutesGet200ResponsePagination) IsSet() bool {
	return v.isSet
}

func (v *NullableV3RoutesGet200ResponsePagination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV3RoutesGet200ResponsePagination(val *V3RoutesGet200ResponsePagination) *NullableV3RoutesGet200ResponsePagination {
	return &NullableV3RoutesGet200ResponsePagination{value: val, isSet: true}
}

func (v NullableV3RoutesGet200ResponsePagination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV3RoutesGet200ResponsePagination) UnmarshalJSON(src []byte) error {
	v.isSet = true
