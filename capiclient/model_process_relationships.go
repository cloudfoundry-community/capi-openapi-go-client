...
type ProcessRelationships struct {
	...
	Revision NullableAppRelationshipsCurrentDroplet `json:"revision,omitempty"`
}
...
// SetRevision gets a reference to the given NullableAppRelationshipsCurrentDroplet and assigns it to the Revision field.
...
func (o *ProcessRelationships) SetRevisionNil() {
	o.Revision.Set(nil)
}
